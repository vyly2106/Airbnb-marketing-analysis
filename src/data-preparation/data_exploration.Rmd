...
The `combined_data` contains listings of 16 analyzed European cities. It captures 192,837 observations in total, and not every city has the same number of listings as one another. Below is an overview of the first few rows and columns of the `combined_data`

```{r load_dataset_as_table, echo = FALSE}
kable(combined_data[1:10, c("id", "name", "room_type", "price", "minimum_nights", "number_of_reviews", "city", "country_code")], col.names = c("id", "name", "room_type", "price", "min_nights", "reviews", "city", "country") , align = "c", caption = "Table 1: Combined dataset of Airbnb listings of 16 cities")
```
...
Without taking the log transformation to cancel out different units of measurement, we may assert a counter-intuitive conclusion, implying Prague is least affordable city for holiday than Zurich. In fact, cities like Zurich, Amsterdam and London are one of the top expensive destinations (Statista, 2021). Besides, logarithm of price is a basic yet effective approach to deal with non-normal distributed data.
