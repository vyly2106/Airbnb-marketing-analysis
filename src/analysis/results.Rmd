...
ListingsCovid <- ListingsCovid %>%
  mutate(Lprice = log(avg_price))
```
...
ListingsCovid_lm0 <- lm(avg_price ~ weekly_count, ListingsCovid)
...
ListingsCovid_lm2 <- lm(
  avg_price ~ weekly_count * room_type +
    minimum_nights +
    reviews_per_month +
    number_of_reviews_ltm +
    availability_365,
