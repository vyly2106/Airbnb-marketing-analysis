...
ggplot(ListingsCovid, aes(avg_price)) + geom_histogram(binwidth = 0.1, color="black", fill= "#FF5A60") + scale_x_log10() + labs(x = "Log of average price", y = "Frequency")
...
ggplot(ListingsCovid,
  ...
  geom_point() +
  scale_y_log10() + labs(y = "Log of average price", x = "Weekly Covid count")
```
...
ggplot(ListingsCovid,
  ...
  facet_wrap(~ country_code) + labs(y = "Log of average price", x = "Weekly Covid count")
```
...
ggplot(ListingsCovid, aes(x = weekly_count, y = residuals_lm1)) + geom_point( color = my_color)+ labs(y = "Log of average price", x = "Weekly Covid count", title= "Heteroskedasticity of model 1") + theme(plot.title = element_text(color="black", size=14, hjust = 0.5,face= "bold"))
```
...
ggplot(ListingsCovid, aes(x = weekly_count, y = residuals_lm2)) + geom_point(color = my_color) + labs(y = "Log of average price", x = "Weekly Covid count", title= "Heteroskedasticity of model 2") + theme(plot.title = element_text(color="black", size=14, hjust = 0.5,face= "bold"))
```
