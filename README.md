...
All the analyzed variables except for room types are measured at a continuous scale, for that reason, we implemented a linear regression method. Besides, in line with prior research [(Falk et al., 2019, Tang et al., 2019, Sainaghi et al., 2021)](http://dx.doi.org/10.1016/j.ijhm.2019.04.023,http://dx.doi.org/10.1016/j.ijhm.2019.03.012,http://dx.doi.org/10.1016/j.ijhm.2020.102709) we applied logarithm transformation to our response variable. Based on our initial exploration, taking the logarithm of price as part of the remedy to deal with the skewed distribution of price observations. 
